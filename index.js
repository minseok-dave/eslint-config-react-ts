...
module.exports = {
    ...
    extends: [
      ...
      'plugin:tailwindcss/recommended', // https://github.com/francoismassart/eslint-plugin-tailwindcss 에서 Supported Rules 적용
    ],
    plugins: ['unused-imports', 'tailwindcss'], // 사용하지 않는 import 모듈을 찾아 제거해주는 plugin ~> https://www.npmjs.com/package/eslint-plugin-unused-imports
    settings: {
      'import/resolver': {
